...
<html>
	...
	<body>
		<div id="wrapper">
			<div id="header">
				<h2>Adhya's Bank Application Withdraw Page</h2>
			</div>
		</div>
		
		<div id="container">
			<h3>Withdraw funds from your account</h3>
			<form action="transferAmount" method="POST"> 
			<!-- Right now this is sending data over to saveCustomer -->	
				<table>
					<tbody>
						<tr>
							<td><label>Account Number of Sender: </label></td>
							<td><input type="number" name="accountNumber" required="required"  pattern="[0-9]{10}"/></td>
						</tr>
						<tr>
							<td><label>Account Number of Recipient: </label></td>
							<td><input type="number" name="accountNumberReciever" /></td>
						</tr>
						<tr>
							<td><label>Transfer Amount: </label></td>
							<td><input type="number" name="amount" size="6" value="0"/></td>
						</tr>
						<tr>							
